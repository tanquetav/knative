...
var (
	...
	ip          = flag.String("ip", "192.168.122.15", "ip address of knative ingress")
	port        = flag.String("port", "32380", "port of call")
	host        = flag.String("host", "mybuild.default.example.com", "host name of revision under test")
